...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'conrepro', 'user' => 'abuelna', 'password' => 'njcm1703', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $e->setEntityNamespaces(array('RegistroBundle' => 'Concurso\\RegistroBundle\\Entity'));
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('concurso\\RegistroBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 10)), 'Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.registro' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(registro|login|login_check|logout|equipo|alumno|inicio|convocatoria|programa|ejemplos|contactos)'))), $this->get('event_dispatcher'));
    }
    protected function getSecurity_Firewall_Map_Context_RegistroService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(inicio|convocatoria|programa|ejemplos|contactos)');
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/registro');
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/equipo');
        $j = new \Symfony\Component\Security\Http\AccessMap();
        $j->add($g, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY', 1 => 'ROLE_USER'), NULL);
        ...
        return $this->services['security.firewall.map.context.registro'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.usuarios')), 'registro', $a, $c), 2 => $l, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $k, 'registro', $m, $n, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5512fa1bceb52', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'registro', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $k, 'login', false), NULL, NULL, $a));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Concurso/EstaticasBundle/Resources/views'), 'ConcursoEstaticas');
        $instance->addPath(($this->targetDirs[3].'/src/Concurso/RegistroBundle/Resources/views'), 'Registro');
    ...
    {
        return $this->services['security.user.provider.concrete.usuarios'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Concurso\\RegistroBundle\\Entity\\Usuario', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'RegistroBundle' => 'Concurso\\RegistroBundle\\RegistroBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'conrepro',
            'database_user' => 'abuelna',
            'database_password' => 'njcm1703',
