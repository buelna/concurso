...
/* ConcursoEstaticasBundle:Default:nuevoUsuario.html.twig */
class __TwigTemplate_d2c08e199f9ac623585b28e53c87b8186e301259e83357330a0403a12e8a33b8 extends Twig_Template
{
...
\t\t\t\t";
        // line 9
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : null), 'form_start', array("action" => $this->env->getExtension('routing')->getPath("usuario_new"), "method" => "POST"));
        echo " 
                    \t";
        // line 10
        ...
        echo "
                        ";
        // line 14
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "password", array()), 'label', array("label" => "Contraseña"));
        echo "
                        ";
        // line 15
        ...
        echo "
                        ";
        // line 16
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "telefono", array()), 'label', array("label" => "Telefono"));
        echo "
                        ";
        // line 17
        ...
        echo "
                        ";
        // line 18
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "captcha", array()), 'widget');
        echo "
                        <br>
...
";
    ...
    {
        return "ConcursoEstaticasBundle:Default:nuevoUsuario.html.twig";
    }
