...
class __TwigTemplate_60dd70314d34502ffce7f93ff43f3397e98f8f150c8918447e6c1b468464d58e extends Twig_Template
{
    ...
    \t\t<div class=\"large-6 columns\" >
        \t\t";
        // line 10
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : null), 'form_start', array("action" => $this->env->getExtension('routing')->getPath("equipo_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "method" => "PUT"));
        echo " 
                    ";
        // line 11
